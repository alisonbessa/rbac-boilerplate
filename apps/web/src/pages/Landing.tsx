...
export default function LandingPage() {
  return (
    <HelmetProvider>
      <Helmet>
        <title>RBAC Boilerplate — Secure fullstack starter</title>
        <meta
          name="description"
          content="Fullstack monorepo with auth, RBAC, flags, storage and great DX."
        />
        <link rel="canonical" href="/" />
        <meta property="og:title" content="RBAC Boilerplate" />
        <meta property="og:description" content="Secure fullstack starter with modern tooling." />
      </Helmet>
